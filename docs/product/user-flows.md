...
- Rechercher : saisir au moins trois caractères dans la barre de la carte, choisir une suggestion IGN, recentrer la carte et afficher un repère distinct sans verdict de sécurité.
...
- S’informer : retrouver les numéros d’urgence et les premiers réflexes, comprendre les points, hachures, zones EFFIS et flèches de vent, puis ouvrir FR-Alert, Géorisques/Météo des forêts ou l’annuaire officiel des préfectures. Aucun flux national structuré n’est encore synchronisé dans Sentinel.
- Urgence : appeler 112/18, obtenir et partager ses coordonnées, lire la dernière consigne connue.
- Signaler (prototype local) : toucher un point ouvre automatiquement une popup proposant « Signaler ici » ou « Annuler ». « Signaler ici » conserve la carte en arrière-plan et ouvre une feuille express avec trois actions maximum : choisir la catégorie, capturer éventuellement une photo/vidéo, publier. Le point et l’heure actuelle sont préremplis. Adresse, coordonnées, autre heure, description et lien public sont regroupés derrière « Ajouter des détails ». La modale se ferme et le marqueur apparaît sur la carte.
- Vérifier (prototype local) : ouvrir un marqueur communautaire et choisir « Je confirme » ou « Je conteste ». Les votes changent le statut communautaire mais ne produisent jamais une confirmation officielle.
